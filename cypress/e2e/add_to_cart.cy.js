...
describe("add to cart",()=>{
    ...
    // });
        ...
        // cy.get('select[name="order.cardType"]').select('MasterCard')        
    //    cy.get(add_to_cart_fish.card_type).select('MasterCard')
        
                cy.get(add_to_cart_fish.card_type).select(fish_data.card_type)        
